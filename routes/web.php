...
// ----------------- ROUTES SUPPRIMÉES (CONFLITS) -----------------
// SUPPRIMEZ CES LIGNES :
// Route::resource('medias', MediaController::class)->except(['index']); // LIGNE 112
// Route::get('typemedias', [TypemediaController::class, 'indexApi']); // LIGNE 114
// Route::get('/typemedias', [TypemediaController::class, 'index'])->name('typemedias.index'); // DÉJÀ DÉFINI LIGNE 29
