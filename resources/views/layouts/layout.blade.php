          ...
          <ul class="navbar-nav ms-auto">
                ...
                <a href="#" class="dropdown-item">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <p class="fs-7">Nouveau commentaire sur votre publication...</p>
                      <p class="fs-7 text-secondary"><i class="bi bi-clock-fill me-1"></i> 2 Heures</p>
                    </div>
                  </div>
                </a>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end glass-effect">
                ...
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item">
                  <i class="bi bi-people-fill me-2"></i> 5 nouveaux utilisateurs
                  <span class="float-end text-secondary fs-7">12 mins</span>
                </a>
                <div class="dropdown-divider"></div>
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/contenus" class="nav-link">
                      <i class="nav-icon bi bi-file-text"></i>
                      <p>Contenus</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/typecontenus" class="nav-link">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/medias" class="nav-link">
                      <i class="nav-icon bi bi-image"></i>
                      <p>Médias</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/typemedias" class="nav-link">
                    ...
                    <div class="direct-chat-messages">
                      <div class="direct-chat-msg">
                        <div class="direct-chat-infos clearfix">
                          <span class="direct-chat-name float-start">Koffi A.</span>
                          <span class="direct-chat-timestamp float-end">23 Jan 2:00 pm</span>
                        </div>
                        <img class="direct-chat-img" src="./assets/img/user1-128x128.jpg" alt="message user image" />
                        <div class="direct-chat-text">Nouvel article sur les traditions vodoun</div>
                      </div>
                      <div class="direct-chat-msg end">
                        <div class="direct-chat-infos clearfix">
                          <span class="direct-chat-name float-end">Marie D.</span>
                          <span class="direct-chat-timestamp float-start">23 Jan 2:05 pm</span>
                        </div>
                        <img class="direct-chat-img" src="./assets/img/user3-128x128.jpg" alt="message user image" />
                        <div class="direct-chat-text">Galerie photos - Artisanat local</div>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <script>
      ...
      const salesChartOptions = {
        ...
        chart: {
          ...
          type: 'area',
          toolbar: { show: false },
          foreColor: getComputedStyle(document.documentElement).getPropertyValue('--futur-primary')
        },
        ...
        tooltip: { theme: htmlElement.getAttribute('data-bs-theme') },
      ...
      // Mise à jour dynamique du thème pour les graphiques
      themeToggle.addEventListener('change', function() {
        const theme = this.checked ? 'light' : 'dark';
        salesChart.updateOptions({
          tooltip: { theme: theme },
          chart: { foreColor: theme === 'dark' ? '#ccc' : '#333' }
        });
      });
    </script>
  </body>
